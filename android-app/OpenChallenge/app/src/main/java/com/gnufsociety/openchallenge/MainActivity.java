...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void clickBottomBar(View view){
        BottomButton bt = (BottomButton) view;
        if (last != null)
            last.clickIt();
        ...
        switch (bt.getId()){
            case R.id.home_bottom:
                f = manager.findFragmentByTag(Fragment1.TAG);
                if (f == null)
                    f = new Fragment1();
            ...
            case R.id.map_bottom:
                f = manager.findFragmentByTag(Fragment2.TAG);
                if (f == null)
                    f = new Fragment2();
                manager.beginTransaction()
                        .replace(R.id.home_fragment, f, Fragment2.TAG)
                        .addToBackStack(Fragment2.TAG)
                        .commit();
                break;
            case R.id.add_bottom:
                f = manager.findFragmentByTag(Fragment3.TAG);
                if (f == null)
                    f = new Fragment3();
                manager.beginTransaction()
                        .replace(R.id.home_fragment, f, Fragment3.TAG)
                        .addToBackStack(Fragment3.TAG)
                        .commit();
                break;
            case R.id.favorite_bottom:
                f = manager.findFragmentByTag(Fragment4.TAG);
                if (f == null)
                    f = new Fragment4();
                manager.beginTransaction()
                        .replace(R.id.home_fragment, f, Fragment4.TAG)
                        .addToBackStack(Fragment4.TAG)
                        .commit();
                break;
            case R.id.profile_bottom:
                f = manager.findFragmentByTag(Fragment5.TAG);
                if (f == null)
                    f = new Fragment5();
                manager.beginTransaction()
                        .replace(R.id.home_fragment, f, Fragment5.TAG)
